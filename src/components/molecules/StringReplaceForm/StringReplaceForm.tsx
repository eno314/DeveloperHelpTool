...
class StringReplaceForm extends React.Component<{}, State> {
  ...
  onChangeReplacedTextarea (e: React.ChangeEvent<HTMLTextAreaElement>): void {
    this.setState({
      replacedStr: e.target.value
    })
  }

  onChangeTargetSubstr (e: React.ChangeEvent<HTMLInputElement>): void {
    this.setState({
      targetSubstr: e.target.value
    })
  }

  onChangeNewSubstr (e: React.ChangeEvent<HTMLInputElement>): void {
    this.setState({
      newSubstr: e.target.value
    })
  }

  onClickReplace (e: React.MouseEvent<HTMLElement>): void {
